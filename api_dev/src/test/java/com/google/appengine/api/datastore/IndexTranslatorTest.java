...
public class IndexTranslatorTest {
  ...
  public void testConversion() {
    ...
    OnestoreEntity.CompositeIndex.Builder ci =
        OnestoreEntity.CompositeIndex.newBuilder().setId(10).setDefinition(pb);
  ...
  public void testIgnoreGeoMode() {
    OnestoreEntity.CompositeIndex.Builder ci =
        OnestoreEntity.CompositeIndex.newBuilder()
            .setAppId("foo")
            .setId(1)
            .setState(OnestoreEntity.CompositeIndex.State.WRITE_ONLY);
    OnestoreEntity.Index indexPb =
        OnestoreEntity.Index.newBuilder()
            .setEntityType("Mountain")
            .setAncestor(false)
            .addProperty(
