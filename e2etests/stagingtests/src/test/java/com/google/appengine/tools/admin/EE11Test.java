...
/** Tests for the Application where EE11 should be set automatically */
public class EE11Test extends TestCase {
  ...
  private static String getSDKRoot() {
    ...
    try {
      ...
      Logger.getLogger(EE11Test.class.getName()).log(Level.SEVERE, null, ex);
    }
    return sdkRoot;
  }
  ...
  @Test
  public void testEE11() throws IOException {
    Application ignored = Application.readApplication(TEST_JAKARTA_APP);
    assertThat(Boolean.getBoolean("appengine.use.EE11")).isTrue();
  }
}
