...
public class AppEngineSessionData extends SessionData {
   ...
   * The standard {@link SessionData#getAllAttributes} return unmodifiable map, which if
   * stored in memcache or datastore, may be passed to an older session implementation that
   * is expecting a mutable map.
