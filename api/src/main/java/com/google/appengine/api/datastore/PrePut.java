 ...
 * is written to the datastore. If {@link #kinds()} is not provided the callback will execute for
 * all kinds. Methods with this annotation must return {@code void}, must accept a single argument
 * of type {@link PutContext}, must not throw any checked exceptions, must not be static, and must
