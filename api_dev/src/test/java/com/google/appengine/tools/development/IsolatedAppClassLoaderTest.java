...
public final class IsolatedAppClassLoaderTest {
  private static final String WEB_DEFAULT_LOCATION_DEVAPPSERVER_PATH =
      "com/google/appengine/tools/development/jetty/webdefault.xml";

  @Test
  @org.junit.Ignore
  public void calculateCorrectContentForServletsFiltersDevappServer() throws Exception {
    Set<String> classes = getClassesInAppDefinition(WEB_DEFAULT_LOCATION_DEVAPPSERVER_PATH);
    assertThat(classes).hasSize(56);
    ImmutableSet<String> classesFromWebDefaultJetty12 =
        ImmutableSet.of(
    ...
    assertThat(classes).containsExactlyElementsIn(classesFromWebDefaultJetty12);
  }
