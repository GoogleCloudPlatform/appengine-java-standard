...
public class StaticFileUtils {
   ...
   * appengine-web.xml.
   *
   * <p>We follow the same logic that is used in production App Engine. This includes:
   *
   * <ul>
   ...
   *   <li>If the expiration time is zero then we specify that the response should not be cached
   ...
   *
   * <p>Also if the expiration time is specified but cannot be parsed as a non-negative number of
