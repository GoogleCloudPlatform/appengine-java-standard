...
public class EE11SessionManagerHandler {
  ...
  private EE11SessionManagerHandler(
  ...
  public static EE11SessionManagerHandler create(Config config) {
    ...
    if (config.enableSession()) {
      ...
      return new EE11SessionManagerHandler(idManager, cache, memcacheMap);
      ...
      context.getSessionHandler().setSessionCache(cache);
      return new EE11SessionManagerHandler(/* idManager= */ null, cache, /* memcacheMap= */ null);
    }
  }
  ...
  public abstract static class Config {
    ...
    public static Builder builder() {
      return new AutoValue_EE11SessionManagerHandler_Config.Builder()
