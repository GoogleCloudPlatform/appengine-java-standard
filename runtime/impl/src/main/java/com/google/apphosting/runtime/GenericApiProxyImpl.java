 ...
 *
 */
public class GenericApiProxyImpl implements ApiProxy.Delegate<GenericApiProxyImpl.EnvironmentImpl> {
  ...
  public static Builder builder() {
    return new AutoBuilder_GenericApiProxyImpl_Builder()
  ...
  public abstract static class Builder {
    ...
    public abstract GenericApiProxyImpl build();
  }
  ...
  public static final class EnvironmentImpl implements ApiProxy.EnvironmentWithTrace {
    ...
    /**
     * Get the {@link GenericAppLogsWriter} instance that is used by the
     ...
     */
    @VisibleForTesting
    GenericAppLogsWriter getAppLogsWriter() {
