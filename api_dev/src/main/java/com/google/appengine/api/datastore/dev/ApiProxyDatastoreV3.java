...
import com.google.apphosting.datastore_bytes.proto2api.DatastoreV3Pb.DatastoreService_3.Method;
...
class ApiProxyDatastoreV3 implements DatastoreV3 {
  ...
  @Override
  public DatastoreV3Pb.QueryResult runQuery(Query.Builder req) {
    return makeV3Call(Method.RunQuery, req.build(), DatastoreV3Pb.QueryResult.parser());
  }
