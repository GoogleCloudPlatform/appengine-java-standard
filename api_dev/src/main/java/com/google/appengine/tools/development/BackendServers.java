 ...
 *
 */
public class BackendServers implements BackendContainer,
  ...
  protected Logger logger = Logger.getLogger(BackendServers.class.getName());
  ...
  private static BackendServers instance;

  public static BackendServers getInstance() {
      if (instance ==null) {
              try {
                  instance =
                          (BackendServers) Class.forName(AppengineSdk.getSdk().getBackendServersClassName())
                  ...
                  Logger.getLogger(BackendServers.class.getName()).log(Level.SEVERE, null, ex);
              } 
          }
    return instance;
  }
