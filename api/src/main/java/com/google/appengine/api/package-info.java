 ...
 *
 * @see <a href="http://cloud.google.com/appengine/docs/java/multitenancy/">Multitenancy and the
 *     Namespaces Java API in the <em>Google App Engine Developer's Guide</em></a>.
 */
