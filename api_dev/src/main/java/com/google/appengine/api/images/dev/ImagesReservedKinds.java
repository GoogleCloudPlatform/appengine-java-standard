...
public final class ImagesReservedKinds {
  ...
  /**
   * This is only used in the dev server to assist in tracking when a URL
   * for a image blob has been created and deleted using getServingURL
   * and deleteServingURL.
   */
