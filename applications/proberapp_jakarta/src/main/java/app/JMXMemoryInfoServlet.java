...
public class JMXMemoryInfoServlet extends HttpServlet {
  ...
  public void service(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    logger.log(
        Level.INFO, "JMXMemoryInfoServlet - Executing servlet request for:" + req.getServletPath());
    ...
    sb.append(
        String.format("total.started.thread.count = %d\n", threading.getTotalStartedThreadCount()));
