...
public final class RawValue implements Serializable {
  ...
  public @Nullable Object getValue() {
    if (valueV3 != null) {
      if (valueV3.hasBooleanValue()) {
        ...
        return valueV3.getStringValue().toByteArray();
  ...
  private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
    int version = in.read();
    PropertyValue.Builder valueV3Builder = PropertyValue.newBuilder();
    if (version == 1) {
      boolean parsed = true;
      try{
        valueV3 = valueV3Builder.mergeFrom(in, ExtensionRegistry.getEmptyRegistry()).build();
