...
/**
 * Identifies a callback method to be invoked before a {@link Query} for any of the specified kinds
 * is executed against the datastore. If {@link #kinds()} is not provided the callback will execute
 * for queries against all kinds, including kind-less queries. Methods with this annotation must
 * return {@code void}, must accept a single argument of type {@link PreQueryContext}, must not
