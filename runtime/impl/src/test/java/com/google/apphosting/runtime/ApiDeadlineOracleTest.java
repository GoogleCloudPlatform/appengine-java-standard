...
public class ApiDeadlineOracleTest {
  ...
  public void testDeadline_Default() {
    assertThat(oracle.getDeadline("foo", false, null)).isEqualTo(10.0);
    assertThat(oracle.getDeadline("foo", true, null)).isEqualTo(5.0);
    assertThat(oracle.getDeadline("foo", false, 50)).isEqualTo(10.0);
    assertThat(oracle.getDeadline("foo", true, 50)).isEqualTo(10.0);
  ...
  public void testDeadline_InitialPackageOverride() {
    // "blobstore" is one of the packages with specific deadlines in the hardcoded map.
    assertThat(oracle.getDeadline("blobstore", false, null)).isEqualTo(15.0);
    assertThat(oracle.getDeadline("blobstore", true, null)).isEqualTo(15.0);
    assertThat(oracle.getDeadline("blobstore", false, 3600)).isEqualTo(30.0);
    assertThat(oracle.getDeadline("blobstore", true, 3600)).isEqualTo(30.0);
  }
