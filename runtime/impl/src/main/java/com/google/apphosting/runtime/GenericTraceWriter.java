 ...
 */
public class GenericTraceWriter {
  @VisibleForTesting
  ...
  public GenericTraceWriter(CloudTraceContext context, GenericResponse upResponse) {
    this(context, upResponse, false);
  }

  private GenericTraceWriter(CloudTraceContext context, GenericResponse upResponse, boolean background) {
  ...
  @Nullable
  public static GenericTraceWriter getTraceWriterForRequest(
      GenericRequest upRequest, GenericResponse upResponse) {
    ...
    return new GenericTraceWriter(traceContext, upResponse, background);
  }
