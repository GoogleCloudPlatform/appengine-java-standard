...
/** */
public class DelegatingModulesFilterHelper extends com.google.appengine.tools.development.DelegatingModulesFilterHelper
    implements ModulesFilterHelper {

  public DelegatingModulesFilterHelper(
      BackendServersBase backendServers,
      com.google.appengine.tools.development.Modules modules) {
  ...
  public void forwardToInstance(
    ...
    if (isBackend(moduleOrBackendName)) {
      ...
      ((Modules) modules).forwardToInstance(moduleOrBackendName, instance, hrequest, response);
    }
  }
}
