 ...
 */
public class EE11AppVersionHandlerFactory implements AppVersionHandlerFactory {
  ...
  public EE11AppVersionHandlerFactory(Server server, String serverInfo) {
    this(server, serverInfo, false);
  }

  public EE11AppVersionHandlerFactory(
  ...
  private org.eclipse.jetty.server.Handler doCreateHandler(AppVersion appVersion)
    ...
    try {
      ...
      // org.eclipse.jetty.ee11.webapp.Configuration file from
       ...
       */
      // TODO: uncomment when shaded org.eclipse.jetty.ee11.webapp.Configuration is fixed.
