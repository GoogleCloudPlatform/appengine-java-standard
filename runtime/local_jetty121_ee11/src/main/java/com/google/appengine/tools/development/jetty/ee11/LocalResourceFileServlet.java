 ...
 *
 * <p>A few remaining Jetty-centric details remain, such as use of the {@link ServletContextHandler}
...
public class LocalResourceFileServlet extends HttpServlet {
  ...
  public void init() throws ServletException {
    ...
    try {
      ...
      logger.atWarning().withCause(ex).log("Could not initialize:");
   ...
   * from the {@link ServletContextHandler} for this servlet, or <code>"index.jsp" , "index.html"
   * </code> if that is <code>null</code>.
   *
