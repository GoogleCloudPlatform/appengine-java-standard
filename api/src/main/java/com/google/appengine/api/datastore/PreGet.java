...
/**
 * Identifies a callback method to be invoked before an {@link Entity} of any of the specified kinds
 * is fetched from the datastore via a get() rpc. If {@link #kinds()} is not provided the callback
 * will execute for all kinds. Methods with this annotation must return {@code void}, must accept a
 * single argument of type {@link PreGetContext}, must not throw any checked exceptions, must not be
